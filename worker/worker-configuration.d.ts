/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 31fd51e3a287362f3e41d3d7b4279fc6)
...
interface __BaseEnv_Env {
	...
	DB: D1Database;
	QUEUE: Queue;
	CART_DO: DurableObjectNamespace<import("./src/index").CartDO>;
	INVENTORY_DO: DurableObjectNamespace<import("./src/index").InventoryDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CartDO" | "InventoryDO";
	}
